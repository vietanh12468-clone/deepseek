...
import { EmbeddingsList, Index, Pinecone, QueryResponse } from '@pinecone-database/pinecone';
...
export class PineconeService implements OnModuleInit {
    ...
    async createIdNameSpace(id: string, idName: string | null = null): Promise<void> {
        try {
